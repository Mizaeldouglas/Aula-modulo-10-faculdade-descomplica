...
const ListarTarefa = () => {
  ...
  return (
    <>
      <Card style={{ backgroundColor: "#282c34", color: "white",display:'flex',flexDirection:'column' , alignItems: 'center', justifyContent:'center' }}>
        ...
        <CardContent>
          <TableContainer component={Paper}>
            ...
            >
              <TableHead>
                <TableRow>
                  <TableCell style={{ backgroundColor: "#282c34", color: '#fff' }}>
                    #
                  </TableCell>
                  <TableCell style={{ backgroundColor: "#282c34", color: '#fff' }}>
                    Título
                ...
                {tarefas.map((row, indice) => (
                  <TableRow
                    ...
                    sx={{
                      ...
                      backgroundColor:
                        hoveredRow === indice ? "#f2f2f2" : "white",
                      color: hoveredRow === indice ? "black" : "inherit",
                    }}
